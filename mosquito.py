...
class Mosquito:
    ...
    def define_spawn_pos(self, size): # chivinning boshlang'ich pozitsiyasini va harakatlanishini aniqlaymiz
    ...
    def animate(self): #kerak bo'lganda hasharotning ramkasini o'zgartirish mumkin
        t = time.time()
    ...
    def kill(self, mosquitos): # chivinni ro'yxatdan olib tashlang
